...
<body>
  <main>
    <section class="container wrapper">
      <h2 style="color:white;" class="display-4 pt-3 "><strong>Login</strong></h2>
          <p style="color:white;" class="text-center"><strong>Please fill this form to create an account.</strong></p>
          <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
            ...
            <p style="font-size:1em; color:white;">Don't have an account? <a href="register.php"><strong>Sign in</strong></a>.</p>
          </form>
    </section>
  </main>
</body>
